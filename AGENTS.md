...
- `src/kimi_bridge/platforms/qq.py` — the handwritten QQ official-bot transport and adapter: access-token refresh, REST client, WS gateway (identify/heartbeat/resume), stable-frontier markdown rendering, append-monotonic `stream_messages` streaming, correction withdrawal, passive/active reply budget bookkeeping, media upload, and inbound dedupe/allowlisting all stay here.
