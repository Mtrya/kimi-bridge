...
- `src/kimi_bridge/speech.py` — the platform-neutral Whisper-compatible HTTP transcriber for inbound voice messages; adapters keep platform-native recognition to themselves.
